...
from pdf_processing import process_pdf_for_nlp  # Import PDF processing functions
...
class DataTrainingArguments:
    ...
    qg_format: Optional[str] = field(
        ...
        metadata={"help": "How to format inputs for question generation, 'highlight_qg_format' or 'prepend_qg_format'"},
    )
...
def main():
    ...
    logger.info("Evaluating data performance...")
    # Perform evaluation here using two performance metrics
    # For demonstration purpose, let's assume two arbitrary metrics: accuracy and F1 score
    accuracy = 0.85
    f1_score = 0.78
